...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-white dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md border-shadow:2xl shadow-black">
        ...
        <div className="flex items-center mb-6">
          ...
          <Button
            ...
            variant="outline"
            className="text-gray-800 dark:text-gray-200 hover:text-gray-200"
          >
            Set
          </Button>
        </div>
